...
Figure 2: The list of checked out books issued to member to be verified by staff at exit. 
...
Figure 1:  Libraryvisitor database table structure/schema
...
Acknowledgement
    • Dr. Akhandanand Shukla, Discusion on idea to create such application.
    • Mr. Amit Kumar Pal, Idea to fetch the issued book data.
    • Mr. Amit Uraon, Idea to incorporate message during member Check In/Out.
    • Dr. Apurba Jyoti Majumder, Testing software in real environment.
    • Ms. Maithili Mishra, Design ideas.
    • So many other Professional friends/teachers motivated during entire project.
